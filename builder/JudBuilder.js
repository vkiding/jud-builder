...
let defaultExt = ['ju', 'vue', 'js']
class JudBuilder extends WebpackBuilder {
    ...
    initConfig() {
        ...
        let judLoader = loadModulePath('jud-loader')
        ...
        this.config.resolveLoader = {
            root: pathTool.dirname(judLoader)
        }
        this.config.resolve = {
            alias: {
